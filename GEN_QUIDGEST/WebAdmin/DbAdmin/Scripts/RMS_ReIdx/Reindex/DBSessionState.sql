...
SET @SQL = N'
CREATE DATABASE [ASPStateRMS]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStateRMS'', FILENAME = N''' + @SQLDataFolder + 'ASPStateRMS.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStateRMS_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStateRMS_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStateRMS_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStateRMS_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStateRMS_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStateRMS] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStateRMS] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
