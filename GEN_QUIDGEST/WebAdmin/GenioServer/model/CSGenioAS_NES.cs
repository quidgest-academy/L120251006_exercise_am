...
namespace CSGenio.business
{
	...
	public class CSGenioAs_nes : DbArea
	{
		...
		public CSGenioAs_nes(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL RMS CONSTRUTOR S_NES]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
        ...
        public static CSGenioAs_nes search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
