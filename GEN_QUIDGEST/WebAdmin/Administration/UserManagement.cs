...
namespace Administration
{
    ...
    public class UserManagement : IUserManagementService
    {
        ...
        public List<ModulesLevel> GetPermissions()
        {
            ...
            perm.Add(new ModulesLevel("RMS", Resources.Resources.MY_APPLICATION56216, "1", Resources.Resources.CONSULTA40695));
            perm.Add(new ModulesLevel("RMS", Resources.Resources.MY_APPLICATION56216, "20", Resources.Resources.OFFICER20358));
            perm.Add(new ModulesLevel("RMS", Resources.Resources.MY_APPLICATION56216, "30", Resources.Resources.AGENT00994));
            perm.Add(new ModulesLevel("RMS", Resources.Resources.MY_APPLICATION56216, "99", Resources.Resources.ADMINISTRADOR57294));
        ...
        public bool CreateUserWithPassAndLevels(string username, string password, List<ModulesLevel> levels)
        {
            ...
            try
            {
                ...
                CSGenioApsw userPsw = new CSGenioApsw(user, "RMS");
