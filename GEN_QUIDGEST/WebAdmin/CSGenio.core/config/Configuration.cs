...
namespace CSGenio.framework
{
    ...
    public static class Configuration
    {
        ...
        /// Application version
        /// </summary>
        public static int Version { get; } = 2513;

        /// <summary>
        /// System id
        /// </summary>
        public static string Program { get; } = "RMS";
        ...
        /// Modules
        /// </summary>
        public static readonly List<string> Modules = ["RMS"];
        ...
        /// </summary>
        public const int VersionDbGen = 2513;

        /// <summary>
        /// Version of the database indexes
        /// </summary>
        public const int VersionIdxDbGen = 15;
        ...
        /// </summary>
        public const string GenioVersion = "374.11";

        /// <summary>
        /// Solution build version
        /// </summary>
        public const int BuildVersionGen = 52;
        ...
        {
			// USE /[MANUAL RMS RESOLVEDATASYSTEM]/
            DataSystemXml ds;
            switch (db)
            {
