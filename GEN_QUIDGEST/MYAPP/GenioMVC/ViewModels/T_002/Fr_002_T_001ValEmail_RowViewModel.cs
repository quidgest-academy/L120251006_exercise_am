...
public class Fr_002_T_001ValEmail_RowViewModel : Models.T_001
{
	#region Constructors

	public Fr_002_T_001ValEmail_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Fr_002_T_001ValEmail_RowViewModel(UserContext userContext, CSGenioAt_001 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
