...
{
	public class RMS_Menu_21_ViewModel : MenuListViewModel<Models.T_002>
	{
		/// <summary>
...
// USE /[MANUAL RMS LIST_LIMITS 21]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.T_002.AddEPH<CSGenioAt_002>(ref u, crs, "ML21");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.T_002.AddEPH<CSGenioAt_002>(ref u, null, "ML21"));
			}
...
// USE /[MANUAL RMS OVERRQ 21]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAt_002>(m_userContext, false, rms_menu_21Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML21", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL RMS OVERRQLIST 21]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAt_002.GetInformation(), QMVC_POS_RECORD, sorts, rms_menu_21Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAt_002> listing = Models.ModelBase.Where<CSGenioAt_002>(m_userContext, distinct, rms_menu_21Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML21", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<RMS_Menu_21_RowViewModel> MapRMS_Menu_21(ListingMVC<CSGenioAt_002> Qlisting)
		{
		...
		private RMS_Menu_21_RowViewModel MapRMS_Menu_21(CSGenioAt_002 row)
		{
...
// USE /[MANUAL RMS VIEWMODEL_CUSTOM RMS_MENU_21]/
		...
		[
			"T_002", "T_002.ValCodt_002", "T_002.ValZzstate", "T_002.ValPhoto", "T_002.ValTitle", "T_002.ValPrice"
		];
