...
public class Fr_002_ValTab_002_RowViewModel : Models.T_005
{
	#region Constructors

	public Fr_002_ValTab_002_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Fr_002_ValTab_002_RowViewModel(UserContext userContext, CSGenioAt_005 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
