...
public class Fr_002_T_004ValCity_RowViewModel : Models.T_004
{
	#region Constructors

	public Fr_002_T_004ValCity_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Fr_002_T_004ValCity_RowViewModel(UserContext userContext, CSGenioAt_004 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
