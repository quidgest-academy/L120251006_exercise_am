...
public class Fr_002_ValTab_001_RowViewModel : Models.T_006
{
	#region Constructors

	public Fr_002_ValTab_001_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Fr_002_ValTab_001_RowViewModel(UserContext userContext, CSGenioAt_006 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
