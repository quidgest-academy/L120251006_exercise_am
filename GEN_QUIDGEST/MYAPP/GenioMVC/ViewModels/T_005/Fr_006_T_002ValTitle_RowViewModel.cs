...
public class Fr_006_T_002ValTitle_RowViewModel : Models.T_002
{
	#region Constructors

	public Fr_006_T_002ValTitle_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Fr_006_T_002ValTitle_RowViewModel(UserContext userContext, CSGenioAt_002 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
