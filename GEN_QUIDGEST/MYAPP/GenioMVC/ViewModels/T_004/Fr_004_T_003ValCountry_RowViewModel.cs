...
public class Fr_004_T_003ValCountry_RowViewModel : Models.T_003
{
	#region Constructors

	public Fr_004_T_003ValCountry_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Fr_004_T_003ValCountry_RowViewModel(UserContext userContext, CSGenioAt_003 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
