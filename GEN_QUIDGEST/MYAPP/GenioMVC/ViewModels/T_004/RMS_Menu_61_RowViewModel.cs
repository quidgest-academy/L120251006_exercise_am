...
public class RMS_Menu_61_RowViewModel : Models.T_004
{
	#region Constructors

	public RMS_Menu_61_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public RMS_Menu_61_RowViewModel(UserContext userContext, CSGenioAt_004 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
