...
public class Fr_001_At_02ValCountry_RowViewModel : Models.At_02
{
	#region Constructors

	public Fr_001_At_02ValCountry_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Fr_001_At_02ValCountry_RowViewModel(UserContext userContext, CSGenioAat_02 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
