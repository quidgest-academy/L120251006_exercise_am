...
public class Fr_001_At_01ValCountry_RowViewModel : Models.At_01
{
	#region Constructors

	public Fr_001_At_01ValCountry_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Fr_001_At_01ValCountry_RowViewModel(UserContext userContext, CSGenioAat_01 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
