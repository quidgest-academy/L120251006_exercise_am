...
{
	public class RMS_Menu_321_ViewModel : MenuListViewModel<Models.T_003>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<RMS_Menu_321_RowViewModel> Menu { get; set; }
		...
		{
// USE /[MANUAL RMS LIST_LIMITS 321]/
		...
		public RMS_Menu_321_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="RMS_Menu_321_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public RMS_Menu_321_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public RMS_Menu_321_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<RMS_Menu_321_RowViewModel>();
			...
			{
				// EPH
				crs = Models.T_003.AddEPH<CSGenioAt_003>(ref u, crs, "ML321");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.T_003.AddEPH<CSGenioAt_003>(ref u, null, "ML321"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAt_003> Qlisting, ref CriteriaSet conditions)
		{
				...
				CriteriaSet rms_menu_321Conds = CriteriaSet.And();
				...
				conditions.SubSets.Add(rms_menu_321Conds);
				rms_menu_321Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
				tableReload &= hasAllRequiredLimits;

// USE /[MANUAL RMS OVERRQ 321]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAt_003>(m_userContext, false, rms_menu_321Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML321", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL RMS OVERRQLSTEXP 321]/
...
// USE /[MANUAL RMS OVERRQLIST 321]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAt_003.GetInformation(), QMVC_POS_RECORD, sorts, rms_menu_321Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
					...
					Menu.Elements = MapRMS_Menu_321(listing);
		...
		private List<RMS_Menu_321_RowViewModel> MapRMS_Menu_321(ListingMVC<CSGenioAt_003> Qlisting)
		{
			List<RMS_Menu_321_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapRMS_Menu_321(row));
					i++;
				}
			}
		...
		/// to a RMS_Menu_321_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private RMS_Menu_321_RowViewModel MapRMS_Menu_321(CSGenioAt_003 row)
		{
			var model = new RMS_Menu_321_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL RMS VIEWMODEL_CUSTOM RMS_MENU_321]/
