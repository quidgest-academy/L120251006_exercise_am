...
namespace GenioMVC.Controllers
{
	public partial class U_prfController : ControllerBase
	{
		...
		public U_prfController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL RMS CONTROLLER_NAVIGATION U_PRF]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAu_prf>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL RMS MANUAL_CONTROLLER U_PRF]/
		...
		/// <summary>
		/// Recalculate formulas of the "F_001" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_F_001([FromBody]F_001_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "u_prf",
				(primaryKey) => Models.U_prf.Find(primaryKey, UserContext.Current, "FF_001"),
				(model) => formData.MapToModel(model as Models.U_prf)
			);
		}
		...
		{
			return base.GetDocumsTickets("U_PRF", requestModel.FieldName, requestModel.KeyValue);
		}
