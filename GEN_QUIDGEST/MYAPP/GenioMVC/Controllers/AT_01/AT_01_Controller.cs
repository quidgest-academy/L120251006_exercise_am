...
// USE /[MANUAL RMS INCLUDE_CONTROLLER AT_01]/

namespace GenioMVC.Controllers
{
	public partial class At_01Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public At_01Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL RMS CONTROLLER_NAVIGATION AT_01]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAat_01>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL RMS MANUAL_CONTROLLER AT_01]/
		...
		{
			return base.GetDocumsTickets("AT_01", requestModel.FieldName, requestModel.KeyValue);
		}
