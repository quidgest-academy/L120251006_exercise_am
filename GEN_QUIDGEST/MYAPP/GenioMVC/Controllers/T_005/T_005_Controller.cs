...
namespace GenioMVC.Controllers
{
	public partial class T_005Controller : ControllerBase
	{
		...
		public T_005Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL RMS CONTROLLER_NAVIGATION T_005]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAt_005>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL RMS MANUAL_CONTROLLER T_005]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.T_005 row = new Models.T_005(UserContext.Current, isEmpty: true);
			row.klass.QPrimaryKey = Navigation.GetStrValue("t_005");
			...
			try
			{
				...
				{
					case "FR_006__T_002F_002___":	// Field (DB)
						{
							var model = new Fr_006_ViewModel(UserContext.Current) { editable = false };
							model.MapFromModel(row);
							model.Load_Fr_006__t_002f_002___(qs);
		...
		public JsonResult GetDependants([FromBody]RequestDependantsModel requestModel)
		{
			...
			try
			{
				...
				{
					case "FR_006__T_002F_002___":	// Field (DB)
						values = new Fr_006_ViewModel(UserContext.Current).GetDependant_Fr_006TableT_002F_002(Selected);
						break;
					default: break;
				}
		...
		/// <summary>
		/// Recalculate formulas of the "Fr_006" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Fr_006([FromBody]Fr_006_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "t_005",
				(primaryKey) => Models.T_005.Find(primaryKey, UserContext.Current, "FFR_006"),
				(model) => formData.MapToModel(model as Models.T_005)
			);
		}
		...
		{
			return base.GetDocumsTickets("T_005", requestModel.FieldName, requestModel.KeyValue);
		}
