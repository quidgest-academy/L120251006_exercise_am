...
namespace GenioMVC.Controllers
{
	public partial class T_006Controller : ControllerBase
	{
		...
		public T_006Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL RMS CONTROLLER_NAVIGATION T_006]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAt_006>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL RMS MANUAL_CONTROLLER T_006]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.T_006 row = new Models.T_006(UserContext.Current, isEmpty: true);
			row.klass.QPrimaryKey = Navigation.GetStrValue("t_006");
			...
			try
			{
				...
				{
					case "FR_005__T_002F_002___":	// Field (DB)
						{
							var model = new Fr_005_ViewModel(UserContext.Current) { editable = false };
							model.MapFromModel(row);
							model.Load_Fr_005__t_002f_002___(qs);
							result = model.TableT_002F_002;
						}
						break;
					default:
						break;
		...
		public JsonResult GetDependants([FromBody]RequestDependantsModel requestModel)
		{
			...
			try
			{
				...
				{
					case "FR_005__T_002F_002___":	// Field (DB)
						values = new Fr_005_ViewModel(UserContext.Current).GetDependant_Fr_005TableT_002F_002(Selected);
						break;
					default: break;
				}
		...
		/// <summary>
		/// Recalculate formulas of the "Fr_005" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Fr_005([FromBody]Fr_005_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "t_006",
				(primaryKey) => Models.T_006.Find(primaryKey, UserContext.Current, "FFR_005"),
				(model) => formData.MapToModel(model as Models.T_006)
			);
		}
		...
		{
			return base.GetDocumsTickets("T_006", requestModel.FieldName, requestModel.KeyValue);
		}
