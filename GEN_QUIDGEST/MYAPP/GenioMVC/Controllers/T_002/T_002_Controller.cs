...
namespace GenioMVC.Controllers
{
	public partial class T_002Controller : ControllerBase
	{
		...
		public T_002Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL RMS CONTROLLER_NAVIGATION T_002]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAt_002>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL RMS MANUAL_CONTROLLER T_002]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.T_002 row = new Models.T_002(UserContext.Current, isEmpty: true);
			row.klass.QPrimaryKey = Navigation.GetStrValue("t_002");
					...
					case "FR_002__T_004F_001___":	// Field (DB)
						{
							...
							model.Load_Fr_002__t_004f_001___(qs);
		...
		/// <summary>
		/// Recalculate formulas of the "Fr_002" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Fr_002([FromBody]Fr_002_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "t_002",
				(primaryKey) => Models.T_002.Find(primaryKey, UserContext.Current, "FFR_002"),
				(model) => formData.MapToModel(model as Models.T_002)
			);
		}
		...
		{
			return base.GetDocumsTickets("T_002", requestModel.FieldName, requestModel.KeyValue);
		}
