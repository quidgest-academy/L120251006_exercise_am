...
namespace GenioMVC.Controllers
{
	public partial class T_004Controller : ControllerBase
	{
		...
		public T_004Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL RMS CONTROLLER_NAVIGATION T_004]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAt_004>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL RMS MANUAL_CONTROLLER T_004]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.T_004 row = new Models.T_004(UserContext.Current, isEmpty: true);
			row.klass.QPrimaryKey = Navigation.GetStrValue("t_004");
			...
			try
			{
				...
				{
					case "FR_004__T_003F_001___":	// Field (DB)
						{
							var model = new Fr_004_ViewModel(UserContext.Current) { editable = false };
							model.MapFromModel(row);
							model.Load_Fr_004__t_003f_001___(qs);
							result = model.TableT_003F_001;
						}
						break;
					default:
						break;
		...
		public JsonResult GetDependants([FromBody]RequestDependantsModel requestModel)
		{
			...
			try
			{
				...
				{
					case "FR_004__T_003F_001___":	// Field (DB)
						values = new Fr_004_ViewModel(UserContext.Current).GetDependant_Fr_004TableT_003F_001(Selected);
						break;
					default: break;
				}
		...
		/// <summary>
		/// Recalculate formulas of the "Fr_004" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Fr_004([FromBody]Fr_004_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "t_004",
				(primaryKey) => Models.T_004.Find(primaryKey, UserContext.Current, "FFR_004"),
				(model) => formData.MapToModel(model as Models.T_004)
			);
		}
		...
		{
			return base.GetDocumsTickets("T_004", requestModel.FieldName, requestModel.KeyValue);
		}
