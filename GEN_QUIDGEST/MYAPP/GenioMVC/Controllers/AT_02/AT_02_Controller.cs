...
// USE /[MANUAL RMS INCLUDE_CONTROLLER AT_02]/

namespace GenioMVC.Controllers
{
	public partial class At_02Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public At_02Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL RMS CONTROLLER_NAVIGATION AT_02]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAat_02>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL RMS MANUAL_CONTROLLER AT_02]/
		...
		{
			return base.GetDocumsTickets("AT_02", requestModel.FieldName, requestModel.KeyValue);
		}
