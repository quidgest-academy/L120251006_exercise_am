...
namespace GenioMVC.Controllers
{
	public partial class T_003Controller : ControllerBase
	{
		...
		public T_003Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL RMS CONTROLLER_NAVIGATION T_003]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAt_003>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL RMS MANUAL_CONTROLLER T_003]/
		...
		/// <summary>
		/// Recalculate formulas of the "Fr_003" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Fr_003([FromBody]Fr_003_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "t_003",
				(primaryKey) => Models.T_003.Find(primaryKey, UserContext.Current, "FFR_003"),
				(model) => formData.MapToModel(model as Models.T_003)
			);
		}
		...
		{
			return base.GetDocumsTickets("T_003", requestModel.FieldName, requestModel.KeyValue);
		}
