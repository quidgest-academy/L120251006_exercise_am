...
namespace CSGenio.business
{
	...
	public class CSGenioAprope : DbArea
	{
		...
		public CSGenioAprope(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL RMS CONSTRUTOR PROPE]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "property_name", FieldType.TEXT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "property_price", FieldType.CURRENCY);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("u_prf", new Relation("RMS", "rmsproperty", "prope", "codprope", "codu_prf", "RMS", "rmsu_prf", "u_prf", "codu_prf", "codu_prf"));
		}
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.HumanKeyName="property_name,".TrimEnd(',');
			info.Alias="prope";
			info.IsDomain = true;
		...
		public static FieldRef FldProperty_name { get { return m_fldProperty_name; } }
		private static FieldRef m_fldProperty_name = new FieldRef("prope", "property_name");

		/// <summary>Field : "Property name" Tipo: "C" Formula:  ""</summary>
		public string ValProperty_name
		{
			get { return (string)returnValueField(FldProperty_name); }
			set { insertNameValueField(FldProperty_name, value); }
		}

		/// <summary>Field : "Property Price" Tipo: "$" Formula:  ""</summary>
		public static FieldRef FldProperty_price { get { return m_fldProperty_price; } }
		private static FieldRef m_fldProperty_price = new FieldRef("prope", "property_price");

		/// <summary>Field : "Property Price" Tipo: "$" Formula:  ""</summary>
		public decimal ValProperty_price
		{
			get { return (decimal)returnValueField(FldProperty_price); }
			set { insertNameValueField(FldProperty_price, value); }
		}

		/// <summary>Field : "" Tipo: "CE" Formula:  ""</summary>
		public static FieldRef FldCodu_prf { get { return m_fldCodu_prf; } }
		private static FieldRef m_fldCodu_prf = new FieldRef("prope", "codu_prf");
