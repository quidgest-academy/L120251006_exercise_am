...
namespace CSGenio.business
{
	...
	public class CSGenioAs_arg : DbArea
	{
		...
		public CSGenioAs_arg(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL RMS CONSTRUTOR S_ARG]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("s_apr", new Relation("RMS", "asyncprocessargument", "s_arg", "codargpr", "cods_apr", "RMS", "asyncprocess", "s_apr", "codascpr", "codascpr"));
		}
        ...
        public static CSGenioAs_arg search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
