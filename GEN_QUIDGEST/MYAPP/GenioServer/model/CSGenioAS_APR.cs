...
namespace CSGenio.business
{
	...
	public class CSGenioAs_apr : DbArea
	{
		...
		public CSGenioAs_apr(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL RMS CONSTRUTOR S_APR]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ChildTable[0]= new ChildRelation("s_arg", new String[] {"cods_apr"}, DeleteProc.NA);
			info.ChildTable[1]= new ChildRelation("s_pax", new String[] {"cods_apr"}, DeleteProc.NA);
        ...
        public static CSGenioAs_apr search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
