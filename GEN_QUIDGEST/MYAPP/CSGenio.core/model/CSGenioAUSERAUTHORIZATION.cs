...
namespace CSGenio.business
{
	...
	public class CSGenioAuserauthorization : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.ParentTables.Add("psw", new Relation("RMS", "userauthorization", "userauthorization", "codua", "codpsw", "RMS", "userlogin", "psw", "codpsw", "codpsw"));
		...
		// USE /[MANUAL RMS TABAUX UserAuthorization]/
