    ...
    public class PersistentSupportSQLServer : PersistentSupport
    {
        ...
        public override void transferMSMQLog(bool all)
        {
            ...
            if (!all && Configuration.MaxLogRowDays > 0)
            {
                ...
                filterMQQueues.LesserOrEqual("RMSMQQueues_History", "DATASTATUS", lastDate);
            }
                ...
                using (System.Data.SqlClient.SqlTransaction logTransaction = (System.Data.SqlClient.SqlTransaction)this.Connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        SelectQuery query = new SelectQuery()
                            .Select("RMSMQQueues_History", "CODMQQUEUES", "CODMQQUEUES")
                            .Select("RMSMQQueues_History", "QUEUEID", "QUEUEID")
							.Select("RMSMQQueues_History", "CHANNELID", "CHANNELID")
                            .Select("RMSMQQueues_History", "ANO", "ANO")
                            .Select("RMSMQQueues_History", "USERNAME", "USERNAME")
                            .Select("RMSMQQueues_History", "TABELA", "TABELA")
                            .Select("RMSMQQueues_History", "TABELACOD", "TABELACOD")
                            .Select("RMSMQQueues_History", "QUEUEKEY", "QUEUEKEY")
                            .Select("RMSMQQueues_History", "QUEUE", "QUEUE")
                            .Select("RMSMQQueues_History", "MQSTATUS", "MQSTATUS")
                            .Select("RMSMQQueues_History", "DATASTATUS", "DATASTATUS")
                            .Select("RMSMQQueues_History", "DATACRIA", "DATACRIA")
                            .Select("RMSMQQueues_History", "OPERACAO", "OPERACAO")
                            .Select("RMSMQQueues_History", "RESPOSTA", "RESPOSTA")
                            .Select("RMSMQQueues_History", "SENDNUMBER", "SENDNUMBER")
                            .Select("RMSMQQueues_History", "ZZSTATE", "ZZSTATE")
                            .From("RMSMQQueues_History")
                            .Where(filterMQQueues)
                            .OrderBy("RMSMQQueues_History", "DATACRIA", Quidgest.Persistence.GenericQuery.SortOrder.Ascending);
                        ...
                        using (IDataReader dr = command.ExecuteReader())
                        {
                            ...
                            using (System.Data.SqlClient.SqlBulkCopy bulkCopy = new System.Data.SqlClient.SqlBulkCopy(
                                ...
                                logTransaction))
                            {
                                bulkCopy.DestinationTableName = "dbo.RMSMQQueues_History";
