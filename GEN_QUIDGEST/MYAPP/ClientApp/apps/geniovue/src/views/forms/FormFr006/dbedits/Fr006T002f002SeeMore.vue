<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-fr006-t002f002-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FR_006__T_002F_002____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Fr006T002f002SeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FR_006__T_002F_002____SeeMore', false),

				interfaceMetadata: {
					id: 'FR_006__T_002F_002____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FR_006__T_002F_002____SeeMore',
					name: 'FR_006__T_002F_002____SeeMore',
					controller: 'T_005',
					action: 'FR_006_T_002ValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-fr006-t002f002',
				headerTitle: computed(() => this.Resources.PROPERTIES34868),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'FR_006__T_002F_002____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-fr006-t002f002')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Fr_006_Fr_006_T_002ValTitle',
