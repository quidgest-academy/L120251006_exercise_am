<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-fr004-t003f001-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FR_004__T_003F_001____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Fr004T003f001SeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FR_004__T_003F_001____SeeMore', false),

				interfaceMetadata: {
					id: 'FR_004__T_003F_001____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FR_004__T_003F_001____SeeMore',
					name: 'FR_004__T_003F_001____SeeMore',
					controller: 'T_004',
					action: 'FR_004_T_003ValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'FR_004__T_003F_001____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-fr004-t003f001')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Fr_004_Fr_004_T_003ValCountry',
