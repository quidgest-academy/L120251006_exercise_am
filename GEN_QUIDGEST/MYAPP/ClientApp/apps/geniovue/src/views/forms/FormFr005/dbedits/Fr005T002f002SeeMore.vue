<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-fr005-t002f002-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FR_005__T_002F_002____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Fr005T002f002SeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FR_005__T_002F_002____SeeMore', false),

				interfaceMetadata: {
					id: 'FR_005__T_002F_002____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FR_005__T_002F_002____SeeMore',
					name: 'FR_005__T_002F_002____SeeMore',
					controller: 'T_006',
					action: 'FR_005_T_002ValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'FR_005__T_002F_002____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-fr005-t002f002')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Fr_005_Fr_005_T_002ValTitle',
