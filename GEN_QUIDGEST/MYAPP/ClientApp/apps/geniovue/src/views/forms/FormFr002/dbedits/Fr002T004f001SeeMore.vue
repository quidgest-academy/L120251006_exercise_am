<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-fr002-t004f001-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FR_002__T_004F_001____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Fr002T004f001SeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FR_002__T_004F_001____SeeMore', false),

				interfaceMetadata: {
					id: 'FR_002__T_004F_001____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FR_002__T_004F_001____SeeMore',
					name: 'FR_002__T_004F_001____SeeMore',
					controller: 'T_002',
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'FR_002__T_004F_001____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-fr002-t004f001')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Fr_002_Fr_002_T_004ValCity',
