<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-fr002-t001f002-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FR_002__T_001F_002____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Fr002T001f002SeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FR_002__T_001F_002____SeeMore', false),

				interfaceMetadata: {
					id: 'FR_002__T_001F_002____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FR_002__T_001F_002____SeeMore',
					name: 'FR_002__T_001F_002____SeeMore',
					controller: 'T_002',
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'FR_002__T_001F_002____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-fr002-t001f002')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Fr_002_Fr_002_T_001ValEmail',
