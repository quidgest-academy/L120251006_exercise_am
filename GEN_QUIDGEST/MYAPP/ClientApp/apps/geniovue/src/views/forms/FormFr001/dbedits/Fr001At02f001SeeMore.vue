<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-fr001-at02f001-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FR_001__AT_02F_001____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Fr001At02f001SeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FR_001__AT_02F_001____SeeMore', false),

				interfaceMetadata: {
					id: 'FR_001__AT_02F_001____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FR_001__AT_02F_001____SeeMore',
					name: 'FR_001__AT_02F_001____SeeMore',
					controller: 'T_001',
					action: 'FR_001_At_02ValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-fr001-at02f001',
				headerTitle: computed(() => this.Resources.COUNTRIES_OF_RESIDEN59146),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'FR_001__AT_02F_001____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-fr001-at02f001')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Fr_001_At_02ValCountry',
							serverMode: true,
							pkColumn: 'ValCodt_003',
							tableAlias: 'AT_02',
							tableNamePlural: computed(() => this.Resources.COUNTRIES_OF_RESIDEN59146),
							viewManagement: '',
							showLimitsInfo: true,
							tableTitle: '',
						...
						globalEvents: ['changed-AT_02'],
						uuid: 'Fr_001_Fr_001_At_02ValCountry',
